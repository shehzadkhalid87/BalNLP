class CharLevelDedup:
    ...
    def __init__(self, repeat_threshold=0.6, min_length=10):
    ...
    def remove_repetitive_docs(self, documents):
...
class WordRepetitionDedup:
    ...
    def __init__(self, repeat_threshold=0.5, min_words=5):
        self.repeat_threshold = repeat_threshold
    ...
    def has_repetitive_words(self, text: str) -> bool:
        ...
        return repetition_ratio > self.repeat_threshold
...
class RepetitionDedup:
    ...
    def remove_repetitive(self, documents):
